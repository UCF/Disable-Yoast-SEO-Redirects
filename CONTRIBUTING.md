# Contributing to Disable Yoast SEO Redirects
...
The [issue tracker](https://github.com/UCF/Disable-Yoast-SEO-Redirects/issues) in Github is the preferred channel for [bug reports](#bug-reports), [feature requests](#feature-requests) and [submitting pull requests](#pull-requests).

Please do not use the issue tracker for personal support requests.  If you're a developer at UCF, the [#help-plugins Teams channel](https://teams.microsoft.com/l/channel/19%3a5325780226474b76b53d50029eae9e22%40thread.skype/help-plugins?groupId=5e3e72e2-3599-47b3-bcfc-bb3d5b579f12&tenantId=bb932f15-ef38-42ba-91fc-f3c59d5dd1f1) is the best place to get help with your project.
...
2. **Check if the issue has been fixed** &mdash; if you're not running the latest version of the plugin, please check your code against the repo's `master` branch first (`master` will always contain the latest, stable project code). If you are running the latest version, make sure the problem isn't already resolved in an upcoming [milestone](https://github.com/UCF/Disable-Yoast-SEO-Redirects/milestones).

### Submit a bug report
If you've followed the steps above and have a valid bug report to submit, you can submit it by [creating a new issue in Github](https://github.com/UCF/Disable-Yoast-SEO-Redirects/issues/new?template=bug_report.md).
...
Before submitting a new feature request, please think carefully about if the proposed feature aligns with the [goals of the project](https://github.com/UCF/Disable-Yoast-SEO-Redirects/wiki/#about-this-project).
...
You can submit a new feature request by [creating a new issue in Github](https://github.com/UCF/Disable-Yoast-SEO-Redirects/issues/new?template=feature_request.md) and filling out the provided template.
...
2. Clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/Disable-Yoast-SEO-Redirects.git

   # Navigate to the newly cloned directory
   cd Disable-Yoast-SEO-Redirects

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/UCF/Disable-Yoast-SEO-Redirects.git
   ```
...
5. Commit your changes in logical chunks. Please provide [helpful, readable commit messages](https://chris.beams.io/posts/git-commit/) (avoid nondescriptive messages such as "bugfix" or "minor change").
    ...
    If you're making changes to scss or js files, make sure you're minifying **and committing** those minified file changes.  scss and js file processing should be performed using gulp commands provided in the repo (see [gulpfile.js](https://github.com/UCF/Disable-Yoast-SEO-Redirects/blob/master/gulpfile.js))
